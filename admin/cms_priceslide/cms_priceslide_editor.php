...
?>
<script language="javascript" src="cms_priceslide.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_cms_priceslide" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
