...
?>
<a href="index.php?cmd=edit" class="btn green">Add a cms_serviceslide</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("cms_serviceslide");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_cms_serviceslide" >
