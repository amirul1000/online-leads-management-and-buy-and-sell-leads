...
?>
<script language="javascript" src="leadtransaction.js"></script>
...
<a href="index.php?cmd=list" class="btn green">List</a> <br><br>
  <div class="portlet box blue">
      <div class="portlet-title">
          <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","lead transaction"))?></b>
          </div>
          <div class="tools">
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_leadtransaction" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
						 ...
						 <td>Trans Date</td>
						 <td>
						    <input type="text" name="trans_date" id="trans_date"  value="<?=$trans_date?>" class="textbox">
