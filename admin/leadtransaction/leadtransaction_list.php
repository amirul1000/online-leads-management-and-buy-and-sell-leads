...
?>
<a href="index.php?cmd=edit" class="btn green">Add a lead transaction</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("leadtransaction");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_leadtransaction" >
				   ...
				   <td> 
				      ...
				      <div class="table-responsive">	
						 ...
						 <?php
								...
								$info["fields"] = array("leadtransaction.*"); 
