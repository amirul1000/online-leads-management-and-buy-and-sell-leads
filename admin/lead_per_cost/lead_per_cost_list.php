...
?>
<a href="index.php?cmd=edit" class="btn green">Add a lead_per_cost</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("lead_per_cost");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_lead_per_cost" >
				   ...
				   <td> 
				      ...
				      <div class="table-responsive">	
						 ...
						 <?php
								...
								$info["fields"] = array("lead_per_cost.*"); 
