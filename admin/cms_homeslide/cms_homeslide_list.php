...
?>
<a href="index.php?cmd=edit" class="btn green">Add a cms_homeslide</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("cms_homeslide");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_cms_homeslide" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><img src="../../<?=$arr[$i]['file_slide1_472_272']?>" style="width:100px;"></td>
                              <td><img src="../../<?=$arr[$i]['file_slide1_297_118']?>" style="width:100px;"></td>
                              <td><img src="../../<?=$arr[$i]['file_slide1_139_149']?>" style="width:100px;"></td>
                              <td><?=$arr[$i]['slide1_text1']?></td>
                              <td><?=$arr[$i]['slide1_text2']?></td>
                              <td><img src="../../<?=$arr[$i]['file_slide2_395_319_1']?>" style="width:100px;"></td>
                              <td><img src="../../<?=$arr[$i]['file_slide2_361_129']?>" style="width:100px;"></td>
                              <td><img src="../../<?=$arr[$i]['file_slide2_395_319_2']?>" style="width:100px;"></td>
                              <td><?=$arr[$i]['slide2_text1']?></td>
                              <td><?=$arr[$i]['slide2_text2']?></td>
