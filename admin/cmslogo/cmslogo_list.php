...
?>
<a href="index.php?cmd=edit" class="btn green">Add a cmslogo</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("cmslogo");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_cmslogo" >
