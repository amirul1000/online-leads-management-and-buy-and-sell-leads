					                ...
					                <table class="table">
										 <tr>
                                          ...
                                          <tr>
                                                 ...
                                                 <td>Facebook</td>
                                                 <td>
                                                    <input type="text" name="facebook" id="facebook"  value="<?=$facebook?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Twitter</td>
                                                 <td>
                                                    <input type="text" name="twitter" id="twitter"  value="<?=$twitter?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Linkedin</td>
                                                 <td>
                                                    <input type="text" name="linkedin" id="linkedin"  value="<?=$linkedin?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Google</td>
                                                 <td>
                                                    <input type="text" name="google" id="google"  value="<?=$google?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Domain</td>
                                                 <td>
                                                    <input type="text" name="domain" id="domain"  value="<?=$domain?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Revenue</td>
                                                 <td>
                                                    <input type="text" name="revenue" id="revenue"  value="<?=$revenue?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Employees</td>
                                                 <td>
                                                    <input type="text" name="employees" id="employees"  value="<?=$employees?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>SIC</td>
                                                 <td>
                                                    <input type="text" name="SIC" id="SIC"  value="<?=$SIC?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>NAICS</td>
                                                 <td>
                                                    <input type="text" name="NAICS" id="NAICS"  value="<?=$NAICS?>" class="textbox">
                                                 </td>
                                             </tr><tr>
                                                 <td>Status</td>
                                                 <td><?php
