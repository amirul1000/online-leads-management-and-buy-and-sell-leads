...
?>
<a href="index.php?cmd=edit" class="btn green">Add a subscription_type</a> <br><br>
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = subscription;	
										$info2['fields']   = array("current_period_start");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['subscription_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['current_period_start'];	
					                ?>
							   </td>
			  <td>
		                            <?php
