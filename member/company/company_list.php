...
<a href="index.php?cmd=edit" class="btn green">Add a company</a> <br><br>
				                ...
				                <table class="table">
									  <TR>
										...
										<TD  nowrap="nowrap">
										  ...
										  ?>
										  Search Key:
										  <select   name="field_name" id="field_name"  class="text">
										...
										<TD  nowrap="nowrap" align="right"><label for="searchbar"><img src="../images/icon_searchbox.png" alt="Search"></label>
										   <input type="text"    name="field_value" id="field_value" value="<?=$_SESSION["field_value"]?>" class="text"></TD>
                              ...
                              <td>
			                   ...
			                   <td>
		                            <?php
										...
										$info2['where']    =  "1 AND id='".$arr[$i]['state_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['name'];	
					                ?>
							   </td>
			                   <td>
		                            <?php
										...
										$info2['table']    = city;	
										$info2['fields']   = array("name");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['city_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['name'];	
					                ?>
							   </td>
